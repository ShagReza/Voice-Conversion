...
% Load two speech waveforms of the same utterance (from TIMIT)
 [d1,sr] = wavread('C:\Users\Admin\BME\project arshad\data\WAV\W4100.WAV');
 
 for num_subject=100:199
 filename = ['C:\Users\Admin\BME\project arshad\data\WAV\W',num2str(4),num2str(num_subject),'.wav'];
 [d2,sr] = wavread(filename);
 ...
 wavwrite ( d2x, sr ,['C:\Users\Admin\BME\project arshad\data\equal ROS waves\W',num2str(4),num2str(num_subject),'_DTW_',num2str(100),'.wav']);
 end   
