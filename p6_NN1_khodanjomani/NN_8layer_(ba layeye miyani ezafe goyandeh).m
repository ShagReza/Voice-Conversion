...
u11=0.1*rand(n_y1+1,n_b1);
du11=0.001*rand(n_y1+1,n_b1);
u12=0.1*rand(n_b1+1,n_b);
du12=0.001*rand(n_b1+1,n_b);
...
while E>0.01
    ...
    save('C:\Users\Admin\BME\project arshad\result\NN8layer_hazfe sokot roye do jomle baraye har fard mojaza\A2.mat')
